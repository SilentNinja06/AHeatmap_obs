...
var SpiralLoggerPlugin = class extends import_obsidian9.Plugin {
  constructor() {
    ...
    this.api = {
      ...
      getEntriesForDate: (date) => getEntries(this.app).filter((e) => e.date === date).map((e) => ({ date: e.date, time: e.time, kind: e.kind, severity: e.severity })),
      ...
      hadEntryOn: (date) => getEntries(this.app).some((e) => e.date === date),
